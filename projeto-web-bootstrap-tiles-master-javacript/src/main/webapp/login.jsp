...
<html lang="en">
  ...
  <body class="text-center">
    ...
    <form class="form-signin"   >
		 ...
		 <a href="${pageContext.request.contextPath}/" onclick = "validacao()"  class="btn btn-lg btn-primary btn-block" type="submit">Logar</a>
		  <!-- <input class="btn btn-lg btn-primary btn-block" type="submit" onclick = "validacao()" name="enviar" id="enviar"  value="ENVIAR"/> -->
